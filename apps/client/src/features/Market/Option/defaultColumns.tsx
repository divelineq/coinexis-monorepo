import type { TickersOptionResponse } from "@api";
import { createColumnHelper } from "@tanstack/react-table";
import { BsInfoCircle } from "react-icons/bs";
import { Tooltip } from "react-tooltip";

const columnHelper =
	createColumnHelper<TickersOptionResponse["list"][number]>();
		...
		header: () => (
			<div className="flex items-center gap-1">
				...
				<BsInfoCircle
					...
					color="gray"
					data-tooltip-id="bid-tooltip"
					data-tooltip-content="Лучшая цена покупки"
				/>
				<Tooltip id="bid-tooltip" place="bottom" />
			</div>
		),
		...
		header: () => (
			<div className="flex items-center gap-1">
				...
				<BsInfoCircle
					...
					color="gray"
					data-tooltip-id="bid-tooltip"
					data-tooltip-content="Лучшая цена продажи"
				/>
				<Tooltip id="bid-tooltip" place="bottom" />
			</div>
		),
